                            ...
                            <div class="sticky-sidebar mt-1" data-sticky-options="{'bottom': 50}">
                                <div class="summary pt-5">
                                    ...
                                    <table class="order-table">
                                        ...
                                        <tr>
                                            <td style="line-height: 0; padding-bottom: 2rem;" class="summary-subtitle">Order Value</td>
                                            <td style="line-height: 0; padding-bottom: 2rem;" class="summary-subtitle text-body">{{ Config::get('icrm.currency.icon') }}{{ number_format($ordervalue, 2) }}</td>
                                        </tr>
                                        @if ($this->discount > 0)
                                            <tr class="discount">
...
{{--                                    <p style="color:green; font-size: 2rem;">You Save {{ Config::get('icrm.currency.icon') }}{{ $this->totalSave }} on this order</p>--}}
                                    ...
                                    <span class="you-save">
                                        Amaazzzzingg!! You Saved {{ Config::get('icrm.currency.icon') }}{{ number_format($this->totalSave,0) }}/- on this order.
                                    </span><br>
