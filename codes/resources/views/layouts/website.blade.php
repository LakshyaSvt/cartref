...
<head>
    ...
    <!-- Preload Font -->
    {{--
    <link rel="preload" href="{{ asset('fonts/riode.ttf?5gap68') }}" as="font" type="font/woff2"
    ...
    <style>
        ...
        .showroom-dropdown-btn span {
            color: gray;
        }

        .showroom-dropdown-btn span::hover {
            color: #333;
        }
    </style>
