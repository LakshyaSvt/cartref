               ...
               <form @submit.prevent="editOrCreateCollectionImage()">
                  ...
                  <div class="md:flex mb-3">
                     <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                        ...
                        <input id="image" accept="image/*" class="form-input"
                               placeholder="western-wear" type="file" @change="handleImageChange($event)">
                     </div>
                     <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                        <label class="block mb-2 text-sm font-bold text-gray-900" for="mobile_image"
                               title="An image belonging to a specific type, often distinguished by shared characteristics or features.">
                           Background Image (Mobile)</label>
                        <input id="mobile_image" accept="image/*" class="form-input"
                               placeholder="western-wear" type="file" @change="handleMbImageChange($event)">
                     </div>
                  </div>
            ...
            <div class="block">
               <div class="flex flex-wrap items-center justify-between py-4">
                  ...
                  <div class="flex flex-wrap items-center gap-2">
                     <div class="relative">
                        <select v-model="filter_collection_id" class="block appearance-none w-52 leading-tight h-full cursor-pointer text-black bg-white border border-gray-400 focus:outline-none hover:shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-none font-medium rounded-lg text-sm px-3 py-2" title="Collection Group"
                                @change="fetchCollectionImage()">
                           <option selected value="">All Collections</option>
                           <option v-for="(collection) in collection_groups" :key="collection.id" :value="collection.id">{{ collection.group_name }}
                           </option>
                        </select>
                     ...
                     <div class="relative">
                        ...
                        <input v-model="keyword" class="search !w-40" placeholder="Search" type="text"
                  ...
                  <div class="clear-right overflow-x-auto">
                     <div class="table border-solid border border-gray-500 w-full">
                        <div class="table-row table-head">
                           ...
                           <div
                               class="table-cell border-l border-gray-500 text-center uppercase font-semibold p-1 w-28">
                              Last Update
                           </div>
                           <div
                               class="table-cell border-l border-gray-500 text-center uppercase font-semibold p-1 w-28">
                        ...
                        <div v-for="(collection_image, index) in collection_images" v-bind:key="collection_image.id"
                           ...
                           <div
                              ...
                              <img v-if="collection_image.image"
                                   ...
                                   @click="imageModal($store.state.storageUrl + collection_image.image)" @error="imageLoadError">
                           ...
                           <div
                              ...
                              <img v-if="collection_image.mb_image"
                                   ...
                                   class="w-14 h-14 border border-gray-400 mx-auto p-1 rounded-[50%]"
                                   @click="imageModal($store.state.storageUrl + collection_image.mb_image)" @error="imageLoadError">
                              <p v-else class="text-center text-gray-800">--No Image--</p>
                           </div>
         ...
         fetchCollectionImage(url) {
            ...
            axios.get(url, {
               params: {
                  ...
                  status: this.status,
                  collection_id: this.filter_collection_id,
               }
            })
                .then(res => {
                   this.dataLoading = false;
