               ...
               <form @submit.prevent="editOrCreateCategory()">
                  <div class="md:flex mb-3">
                     <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                        <label class="block mb-2 text-sm font-bold text-gray-900" for="category"
                               title="The name is how it appears on your site.">Category <span
                            class="text-red-600">*</span></label>
                        <input id="category" v-model="name" class="form-input" placeholder="Western Wear"
                               required type="text">
                     </div>
                     <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                        ...
                        <input id="slug" v-model="slug" class="form-input" placeholder="western-wear" required
                               type="text">
                     </div>
                  </div>
