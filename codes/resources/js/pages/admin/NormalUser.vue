        ...
        <div class="container mx-auto my-2 px-4">
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex gap-2 items-center text-3xl text-primary-600 font-semibold">
                    ...
                    <h3 class="text-start my-8">Customer</h3>
                </div>
                <div>
                ...
                <div class="block">
                    <div class="flex flex-wrap items-center justify-between py-4">
                        <div class="flex flex-wrap text-base text-gray-700 gap-2">
                            ...
                            <div>
                                <button :disabled="!pagination.prev_page_url" class="prev-next-btn" title="Previous"
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <div class="flex border border-gray-600 rounded-lg bg-white">
                                <button
                                    class="px-2 py-1 m-[2px] hover:bg-primary-100 border-r border-solid cursor-pointer"
                                    @click="fetchUser()">
                        ...
                        <div class="clear-right overflow-x-auto">
                            <div class="table border-solid border border-gray-500 w-full">
                                ...
                                <div v-for="(user, index) in users" v-bind:key="index"
                                    ...
                                    <div
                                        class="table-cell border-t border-l border-gray-500 text-sm px-1 text-center py-1">
                                        {{ user.dbcart ? user.dbcart.length : '0' }}
                                    </div>
                                    <div
                                        class="table-cell border-t border-l border-gray-500 text-sm px-1 text-center py-1">
                                        {{ user.dbwishlist ? user.dbwishlist.length : '0' }}
                                    </div>
                                    <div
                                        class="table-cell border-t border-l border-gray-500 text-sm px-1 text-center py-1">
