                    ...
                    <form @submit.prevent="editOrCreateStyle()">
                        <div class="md:flex mb-3">
                            <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                                <label for="style" class="block mb-2 text-sm font-bold text-gray-900"
                                    title="The name is how it appears on your site.">Style <span
                                        class="text-red-600">*</span></label>
                                <input type="text" v-model="name" id="style" class="form-input" placeholder="Floral Print"
                                    required>
                            </div>
                            <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                                ...
                                <input type="text" v-model="slug" id="slug" class="form-input" placeholder="floral-print"
                                    required>
                            </div>
                        </div>
                ...
                <div class="block">
                    <div class="flex flex-wrap items-center justify-between py-4">
                        <div class="flex flex-wrap text-base text-gray-700 gap-2">
                            ...
                            <div>
                                <button :disabled="!pagination.prev_page_url" @click="fetchStyle(pagination.prev_page_url)"
                                    title="Previous"
                                    class="prev-next-btn">
                                    <i class="fi fi-rr-angle-small-left text-xl px-1 py-2"></i>
                                </button>
                                <button :disabled="!pagination.next_page_url" @click="fetchStyle(pagination.next_page_url)"
                                    title="Next"
                                    class="prev-next-btn">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <div class="flex border border-gray-600 rounded-lg bg-white">
                                ...
                                <select
                                    ...
                                    @change="fetchStyle()" v-model="row_count">
                    ...
                    <template v-else-if="styles && styles.length > 0">
                        <div class="clear-right overflow-x-auto">
                            <div class="table border-solid border border-gray-500 w-full">
                                ...
                                <div v-for="(s, index) in styles" v-bind:key="index"
                    ...
                    <template v-else>
                        <div>
                            <p class="text-center text-2xl">No Styles Found !</p>
                        </div>
                    </template>
                </div>
            </div>
