            ...
            <div class="block">
               <div class="flex flex-wrap items-center justify-between py-4">
                  <div class="flex flex-wrap text-base text-gray-700 gap-2">
                     ...
                     <div>
                        <button :disabled="!pagination.prev_page_url" class="prev-next-btn" title="Previous" @click="fetchWishlist(pagination.prev_page_url)">
                           <i class="fi fi-rr-angle-small-left text-xl px-1 py-2"></i>
                        </button>
                        <button :disabled="!pagination.next_page_url" class="prev-next-btn" title="Next" @click="fetchWishlist(pagination.next_page_url)">
                  ...
                  <div class="flex flex-wrap items-center gap-2">
                     ...
                     <div class="flex border border-gray-600 rounded-lg bg-white">
                        ...
                        <select
                            v-model="row_count"
                            class="w-14 block px-1 m-[2px] text-base text-center text-gray-900 bg-white cursor-pointer" @change="fetchWishlist()">
                  ...
                  <div class="clear-right overflow-x-auto">
                     <div class="table border-solid border border-gray-500 w-full">
                        <div class="table-row table-head">
                           <div class="table-cell border-gray-500 text-center font-semibold uppercase w-10 p-1">S.No.
                           </div>
                     ...
                     <div class="flex items-center justify-between py-4">
                        ...
                        <Pagination :fetchNewData="fetchWishlist" :pagination="pagination"/>
                     </div>
                  </div>
               </template>
               <template v-else>
