                  ...
                  <div class="table border-solid border border-gray-500 w-full">
                     ...
                     <template v-if="sizes && sizes.length > 0">
                        <div v-for="(size, index) in sizes" :key="size.id" class="table-row table-body hover:bg-primary-100 bg-white">
                           ...
                           <div :title="size.length +' cms / ' + size.breath + ' cms / ' + size.height + ' cms / ' + size.weight + ' kgs' "
                                class="table-cell border-t border-l border-gray-500 p-1 text-center"
                           ...
                           <div class="table-cell border-t border-l border-gray-500 p-1 text-center" title="Double click to edit" @dblclick="editStockFunc(size)">
                              <template v-if="editStockId === size.id">
                                 <div class="font-semibold text-gray-600 py-2.5" tabindex="0">
