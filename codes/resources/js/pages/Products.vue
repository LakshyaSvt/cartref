        ...
        <div class="block">
          <div class="flex flex-wrap items-center justify-between py-4">
            <div class="flex flex-wrap text-base text-gray-700 gap-2">
              ...
              <div>
                <button :disabled="!pagination.prev_page_url" @click="fetchProduct(pagination.prev_page_url)"
                  title="Previous"
                  class="border border-transparent rounded-full hover:bg-primary-400 disabled:opacity-50">
                  <i class="fi fi-rr-angle-small-left text-xl px-1 py-2"></i>
                </button>
                <button :disabled="!pagination.next_page_url" @click="fetchProduct(pagination.next_page_url)" title="Next"
                  class="border border-transparent rounded-full hover:bg-primary-400 disabled:opacity-50">
            ...
            <div class="flex flex-wrap items-center gap-2">
              <div class="relative">
                <select title="Sellers" v-model="seller_id" @change="fetchProduct()" class="filter-dropdown">
                  <option value="" selected>All Sellers</option>
              ...
              <div class="relative">
                <select title="Status" v-model="status" @change="fetchProduct()" class="w-28 filter-dropdown">
              ...
              <div class="relative">
                ...
                <input type="text" v-model="keyword" @change="fetchProduct()" class="search" placeholder="Search"
                  title="Search" @keydown.enter="fetchProduct()">
              </div>
              ...
              <div class="table border-solid border border-gray-500 w-full">
                ...
                <div v-for="(product, index) in products" v-bind:key="index"
                  ...
                  <div class="table-cell border-t border-l border-gray-500 text-sm px-1 text-center py-1 !align-middle">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer" :id="'status_' + product.id"
                      :title="product.admin_status === 'Accepted' ? 'Click to Reject' : 'Click to Accept'">
                      <input type="checkbox" :id="'checkbox_' + product.id" value=""
                        :checked="product.admin_status === 'Accepted'" @change="updateStatus(product.id, $event)"
                        class="sr-only peer">
                      <div
                  ...
                  <div class="table-cell border-t border-l border-gray-500 text-sm align-[middle!important] text-center">
                    <div class="flex gap-4 mx-2 items-center justify-center">
                      ...
                      <a href="javascript:void(0)" type="button" class="font-medium cursor-pointer text-red-500">
