...
export default {
  ...
  methods: {
    ...
    deleteImage(img) {
      ...
      this.loading = true;
      axios
          .post(`/vendor/product/color/${this.color_id}/delete-image`, {
            image: img,
          })
          .then(res => {
            this.fetchColor();
    ...
    handleFileChange(e) {
      ...
      axios.post(`/vendor/product/color/${this.color_id}/upload-images`, formData, config)
          .then((res) => {
            this.fetchColor();
            this.show_toast(res.data.status, res.data.msg);
    ...
    updateMainImage(e) {
      ...
      axios
        .post(`/vendor/product/color/${this.color_id}/main-image`, formData, config)
        .then((res) => {
          this.fetchColor();
          this.show_toast(res.data.status, res.data.msg);
        })
