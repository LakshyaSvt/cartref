        ...
        <div class="block">
          <div class="flex flex-wrap items-center justify-between py-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
              <div class="relative">
                <select title="Collection Group" v-model="filter_collection_id" @change="fetchCollectionImage()"
                        class="block appearance-none w-52 leading-tight h-full cursor-pointer text-black bg-white border border-gray-400 focus:outline-none hover:shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-none font-medium rounded-lg text-sm px-3 py-2">
