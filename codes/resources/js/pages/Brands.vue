          ...
          <form @submit.prevent="editOrCreateBrand()">
            <div class="md:flex mb-3">
              <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                <label for="brand" class="block mb-2 text-sm font-bold text-gray-900"
                  title="The name is how it appears on your site.">Brand <span class="text-red-600">*</span></label>
                <input type="text" v-model="name" id="brand" class="form-input" placeholder="Floral Print" required>
              </div>
              <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
        ...
        <div class="block">
          <div class="flex flex-wrap items-center justify-between py-4">
            <div class="flex flex-wrap text-base text-gray-700 gap-2">
              ...
              <div>
                <button :disabled="!pagination.prev_page_url" @click="fetchBrand(pagination.prev_page_url)"
                  title="Previous"
            ...
            <div class="flex flex-wrap items-center gap-2">
              ...
              <div class="flex border border-gray-600 rounded-lg bg-white">
                ...
                <select class="w-14 block px-1 m-[2px] text-base text-center text-gray-900 bg-white cursor-pointer"
                  @change="fetchBrand()" v-model="row_count">
          ...
          <template v-else-if="brands && brands.length > 0">
            <div class="clear-right overflow-x-auto">
              <div class="table border-solid border border-gray-500 w-full">
                ...
                <div v-for="(s, index) in brands" v-bind:key="index" class="table-row table-body hover:bg-primary-100"
          ...
          <template v-else>
            <div>
              <p class="text-center text-2xl">No Brands Found !</p>
            </div>
          </template>
        </div>
      </div>
