            ...
            <div class="md:flex mb-3">
              <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
                <label for="category" class="block mb-2 text-sm font-bold text-gray-900"
                  title="The name is how it appears on your site.">Category <span class="text-red-600">*</span></label>
                <input type="text" v-model="name" id="category" class="form-input" placeholder="Western Wear" required>
              </div>
              <div class="mb-5 md:w-1/2 w-full mx-2 my-1">
        ...
        <div class="block">
          <div class="flex flex-wrap items-center justify-between py-4">
            <div class="flex flex-wrap text-base text-gray-700 gap-2">
              ...
              <div>
                <button :disabled="!pagination.prev_page_url" @click="fetchCategory(pagination.prev_page_url)"
                  title="Previous"
                  class="border border-transparent rounded-full hover:bg-primary-400 disabled:opacity-50">
                  <i class="fi fi-rr-angle-small-left text-xl px-1 py-2"></i>
                </button>
                <button :disabled="!pagination.next_page_url" @click="fetchCategory(pagination.next_page_url)"
          ...
          <template v-else-if="category && category.length > 0">
            <div class="clear-right overflow-x-auto">
              <div class="table border-solid border border-gray-500 w-full">
                ...
                <div v-for="(c, index) in category" v-bind:key="index" class="table-row table-body hover:bg-primary-100"
                  ...
                  <div class="table-cell border-t border-l border-gray-500 text-sm px-1 text-center py-1">{{ c.slug }}
                  </div>
